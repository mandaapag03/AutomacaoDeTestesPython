...
class Estacionamento:
    ...
    def calcular_valor_devido(self, ticket):
        ...
        horas_decorridas = tempo_decorrido.total_seconds() / 3600 # Converter parav horas
        valor_devido = 15 + max(0, horas_decorridas - 1) * 5 # R$ 15 para a primeira hora, R$ 5 para as demais
